            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="header-info header-info-right">
                        ...
                        @else
                        <ul>
                            <li><i class="fi-rs-key"></i><a href="{{ route('login') }}">Войти </a>  / <a href="{{ route('register') }}">Зарегестрироваться</a></li>
                        </ul>
                        @endif
                    </div>
                </div>
        ...
        <div class="container">
            <div class="header-wrap header-space-between position-relative">
                ...
                <div class="header-nav d-none d-lg-flex">
                    <div class="main-categori-wrap d-none d-lg-block">
                        <a class="categori-button-active" href="#">
                            <span class="fi-rs-apps"></span> Выбрать категорию
                        </a>
                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                        <nav>
                            <ul>
                                ...
                                @auth
                                <li><a href="#">Аккаунт<i class="fi-rs-angle-down"></i></a>
                ...
                <div class="hotline d-none d-lg-block">
                    <p><i class="fi-rs-smartphone"></i><span>Телефон</span> (+375) 29 141 50 86 </p>
                </div>
                    ...
                    <div class="header-action-2">
                        <div class="header-action-icon-2">
                            <a href="shop-wishlist.php">
                                <img alt="Drop Dead" src="{{ asset('assets/imgs/theme/icons/icon-heart.svg') }}">
                                ...
                                <ul>
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="product-details.html"><img alt="Drop Dead" src="{{ asset('assets/imgs/shop/thumbnail-3.jpg') }}"></a>
                                        </div>
                                    ...
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="product-details.html"><img alt="Drop Dead" src="{{ asset('assets/imgs/shop/thumbnail-4.jpg') }}"></a>
                                        </div>
                                        <div class="shopping-cart-title">
                ...
                <div class="col-lg-7 mb-md-3 mb-lg-0">
                    <div class="row align-items-center">
                        <div class="col flex-horizontal-center">
                            ...
                            <h4 class="font-size-20 mb-0 ml-3">Зарегестрируйтесь!</h4>
                        </div>
                        <div class="col my-4 my-md-0 des">
                            <h5 class="font-size-15 ml-4 mb-0">...и получите <strong>скидку $25 на все товары!</strong></h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                    ...
                    <form class="form-subcriber d-flex wow fadeIn animated">
                        <input type="email" class="form-control bg-white font-small" placeholder="Введите свою почту">
        ...
        <div class="container pt-15 pb-20">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="widget-about font-md mb-md-5 mb-lg-0">
                        ...
                        <p class="wow fadeIn animated">
                            <strong>Адрес: </strong>562 Wellington Road
                        </p>
                        <p class="wow fadeIn animated">
                            <strong>Телефон: </strong>+1 0000-000-000
                        </p>
                        <p class="wow fadeIn animated">
                            <strong>Почта: </strong>contact@surfsidemedia.in
                        </p>
                ...
                <div class="col-lg-4 mob-center">
                    <h5 class="widget-title wow fadeIn animated">Установите прилоение</h5>
                    <div class="row">
                        <div class="col-md-8 col-lg-12">
                            <p class="wow fadeIn animated">Из App Store или Google Play</p>
                        ...
                        <div class="col-md-4 col-lg-12 mt-md-3 mt-lg-0">
                            <p class="mb-20 wow fadeIn animated">Защита безопасности</p>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <p class="float-md-left font-sm text-muted mb-0">
                    <a href="privacy-policy.html">Политика конфиденциальности</a> | <a href="terms-conditions.html">Terms & Conditions</a>
                </p>
            </div>
            <div class="col-lg-6">
                <p class="text-lg-end text-start font-sm text-muted mb-0">
                    &copy; <strong class="text-brand">Шкуратова Софья</strong> Все права защищены
                </p>
            </div>
        </div>
    </div>
