                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p> Мы нашли <strong class="text-brand">{{$products->total()}}</strong> товаров для вас</p>
                            </div>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget price_range range mb-30">
                            ...
                            <a href="shop.html" class="btn btn-sm btn-default"><i class="fi-rs-filter mr-5"></i> Фильтр</a>
                        </div>
