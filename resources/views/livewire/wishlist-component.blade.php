                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('product.details', ['slug'=>$item->model->slug]) }}">
                                            <img class="default-img"
                                                 src="{{ asset('assets/imgs/shop/product-')}}{{$item->id}}-1.jpg"
                                                 alt="{{$item->name}}">
                                            <img class="hover-img"
                                                 src="{{ asset('assets/imgs/shop/product-')}}{{$item->id}}-2.jpg"
                                                 alt="{{$item->name}}">
                                        </a>
                                    </div>
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <div class="product-action-1 show">
                                            <a aria-label="Remove From Wishlist" class="action-btn hover-up wishlisted"
                                               href="#" wire:click.prevent="removeFromWishlist({{$item->id}})"><i
                                                    class="fi-rs-heart"></i></a>
{{--                                        <a aria-label="Add To Cart" class="action-btn hover-up" href="#"--}}
{{--                                           wire:click.prevent="store({{$item->id}}, '{{ $item->name }}', {{ $item->regular_price }})"><i--}}
